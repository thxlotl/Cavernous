...
execute as @e[tag=geyser,type=armor_stand] at @s if block ~ ~2 ~ #cavernous:geyser_open unless block ~ ~ ~ #cavernous:ice if entity @a[distance=..35] if score @s bubble matches 1 if predicate cavernous:geyser/50 run function geyser:events/bubble
execute as @e[tag=geyser,type=armor_stand] at @s if block ~ ~2 ~ #cavernous:geyser_open unless block ~ ~ ~ #cavernous:ice if entity @a[distance=..35] if score @s burst matches 1 if predicate cavernous:geyser/50 run function geyser:events/burst
