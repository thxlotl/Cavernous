...
execute at @a[predicate=cavernous:in_volcanic] if score .global geyser.enabled matches 0 run fill ~25 ~3 ~25 ~-25 ~-8 ~-25 basalt replace structure_void
execute at @a[predicate=cavernous:in_inactive] if score .global geyser.enabled matches 0 run fill ~25 ~3 ~25 ~-25 ~-8 ~-25 basalt replace structure_void
