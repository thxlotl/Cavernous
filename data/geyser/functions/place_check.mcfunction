...
execute if entity @s[predicate=cavernous:can_be_placed] unless entity @e[tag=!geyser,type=!item,distance=...81] run scoreboard players set @s can_place 1
...
execute unless entity @s[predicate=cavernous:can_be_placed] run scoreboard players set @s can_place 0
