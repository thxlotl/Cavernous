...
execute positioned ~ ~ ~ as @e[distance=..4] unless score @s ancient_staff.casting matches 1 run scoreboard players set @s ancient_staff.casting 0
execute positioned ~ ~ ~ run tag @e[distance=..4,scores={ancient_staff.casting=0}] add to_damage_with_staff
